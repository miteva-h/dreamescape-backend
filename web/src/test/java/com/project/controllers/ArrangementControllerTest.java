...
public class ArrangementControllerTest {
    ...
    private MockMvc mockMvcArrangement;
    ...
    @BeforeEach
    public void setUp() {
        mockMvcArrangement = MockMvcBuilders.standaloneSetup(arrangementController).build();
    ...
    public void findAllDatesForAccommodation_ShouldReturnListOfLocalDate() throws Exception {
        ...
        mockMvcAccommodation.perform(get("/accommodations/{id}/arrangements", accommodationId))
    ...
    public void add_ShouldReturnResponseEntityOfArrangement() throws Exception {
        ...
        mockMvcArrangement.perform(post("/arrangements/add")
    ...
    public void findAllArrangementsForUser_ShouldReturnListOfArrangementsInShoppingCart() throws Exception {
        ...
        mockMvcArrangement.perform(get("/arrangements/user/{username}", username))
                .andExpect(status().isOk())
    ...
    public void deleteById_ShouldReturnResponseEntity() throws Exception {
        ...
        mockMvcArrangement.perform(delete("/arrangements/{id}/delete", id))
                .andExpect(status().isOk());
