...
public class PhotoForPlaceControllerTest {
    ...
    @BeforeEach
    public void setUp() {
        mockMvcPhoto = MockMvcBuilders.standaloneSetup(photoForPlaceController).build();
    ...
    public void findAll_ShouldReturnListOfPhotosForPlace() throws Exception {
        ...
        mockMvcPlace.perform(get("/places/{id}/photos", placeId))
    ...
    public void findById_ShouldReturnResponseEntityOfPhotoForPlace() throws Exception {
        ...
        mockMvcPhoto.perform(get("/photos/{id}", id))
                .andExpect(status().isOk())
    ...
    public void add_ShouldReturnResponseEntityOfPhotoForPlace() throws Exception {
        ...
        mockMvcPlace.perform(post("/places/{id}/photo", id)
    ...
    public void add_ShouldReturnBadRequest() {
        ...
        ResponseEntity<PhotoForPlace> response = placeController.addPhotoToPLace(placeId, photoForPlaceDto);
    ...
    public void deleteById_ShouldReturnResponseEntity() throws Exception {
        ...
        mockMvcPhoto.perform(delete("/photos/1/delete"))
                .andExpect(status().isOk());
